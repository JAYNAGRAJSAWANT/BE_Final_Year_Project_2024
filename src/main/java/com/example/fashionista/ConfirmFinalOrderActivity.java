...
public class  ConfirmFinalOrderActivity extends AppCompatActivity {
    ...
    void payUsingUpi(String amount) {
        Log.d("main ", "payUsingUpi"+amount);
        Uri uri = Uri.parse("upi://pay").buildUpon()
                .appendQueryParameter("pa", "muleprananav10-1@oksbi")       // virtual ID
                .appendQueryParameter("pn", "Pranav Mule")          // name
                // optional
                //.appendQueryParameter("pa", "thoratsakshi551@axl")       // virtual ID
                //.appendQueryParameter("pn", "Sakshi Thorat")
                .appendQueryParameter("tn", "Pay for Shopping")       // any note about payment
                .appendQueryParameter("am", totalAmount+ "")           // amount
        ...
        DatabaseReference ProductsRef = FirebaseDatabase.getInstance("https://trolley-86b9a-default-rtdb.firebaseio.com/").getReference("P1");
        ProductsRef.setValue(0);
